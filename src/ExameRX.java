...
public class ExameRX extends Exame {
    ...
    // Construtor completo
    public ExameRX(LocalDate dataRealizacao, Paciente paciente, String tecnicoResponsavel, String zonaCorpo) {
        super(dataRealizacao, paciente, tecnicoResponsavel);
        this.zonaCorpo = zonaCorpo;
    }

    // Construtor sem zonaCorpo
    public ExameRX(LocalDate dataRealizacao, Paciente paciente, String tecnicoResponsavel) {
        this(dataRealizacao, paciente, tecnicoResponsavel, "Indefinida");
    }

    // Construtor sem tecnicoResponsavel e zonaCorpo
    public ExameRX(LocalDate dataRealizacao, Paciente paciente) {
    ...
    public ExameRX() {
        this(LocalDate.now(), new Paciente(), "Técnico Desconhecido", "Indefinida");
    }
